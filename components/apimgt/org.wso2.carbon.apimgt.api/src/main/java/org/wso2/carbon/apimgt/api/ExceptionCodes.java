...
ExceptionCodes implements ErrorHandler {
    ...
    VHOST_NOT_FOUND(900506, "Virtual Host not found", 404,
            "Virtual Host cannot be found for the given reference id"),
    EXISTING_VHOST_FOUND(900507, "Virtual Host is already exists", 400, "A Virtual Host with %s already exists"),
